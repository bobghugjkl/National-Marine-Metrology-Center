    ...
    <div class="original-records">
        ...
        >
            ...
            <el-table-column prop="station" label="站位" width="120" align="center">
                <template #default="{ row }">
                    <template v-if="row.isEditing">
                        <el-input v-model="row.station" size="small" @click.stop></el-input>
                    </template>
            ...
            <el-table-column prop="location" label="地点" width="120" align="center">
                <template #default="{ row }">
                    <template v-if="row.isEditing">
                        <el-input v-model="row.location" size="small" @click.stop></el-input>
                    </template>
                ...
                <el-row :gutter="20">
                    ...
                    <el-col :span="12">
                        <el-form-item label="站位" prop="station">
                            <el-input v-model="formData.station" placeholder="请输入站位" />
                        </el-form-item>
                    </el-col>
                </el-row>
