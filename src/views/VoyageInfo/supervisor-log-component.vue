    ...
    <div class="supervisor-log">
        ...
        >
            ...
            <el-table-column prop="supervisor" label="监督员" width="120" align="center">
                <template #default="{ row }">
                    <template v-if="row.isEditing">
                        <el-input v-model="row.supervisor" size="small" @click.stop></el-input>
                    </template>
            ...
            <el-table-column prop="inspection_content" label="检查内容" min-width="200">
                <template #default="{ row }">
                    <template v-if="row.isEditing">
                        <el-input v-model="row.inspection_content" size="small" @click.stop></el-input>
                    </template>
            ...
            <el-table-column prop="existing_problems" label="存在问题" min-width="200">
                <template #default="{ row }">
                    <template v-if="row.isEditing">
                        <el-input v-model="row.existing_problems" size="small" @click.stop></el-input>
                    </template>
            ...
            <el-table-column prop="rectification_status" label="整改情况" min-width="200">
                <template #default="{ row }">
                    <template v-if="row.isEditing">
                        <el-input v-model="row.rectification_status" size="small" @click.stop></el-input>
                    </template>
                ...
                <el-row :gutter="20">
                    ...
                    <el-col :span="12">
                        <el-form-item label="监督员" prop="supervisor">
                            <el-input v-model="formData.supervisor" placeholder="请输入监督员" />
                        </el-form-item>
                    </el-col>
                </el-row>
