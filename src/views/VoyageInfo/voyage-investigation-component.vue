    ...
    <div class="voyage-investigation">
        ...
        >
            ...
            <el-table-column prop="investigation_item_instrument" label="调查项目/仪器" min-width="200">
                <template #default="{ row }">
                    <template v-if="row.isEditing">
                        <el-input v-model="row.investigation_item_instrument" size="small" @click.stop></el-input>
                    </template>
            ...
            <el-table-column prop="comparison_unit_a_instrument" label="比测单位甲及仪器" min-width="200">
                <template #default="{ row }">
                    <template v-if="row.isEditing">
                        <el-input v-model="row.comparison_unit_a_instrument" size="small" @click.stop></el-input>
                    </template>
            ...
            <el-table-column prop="comparison_unit_b_instrument" label="比测单位乙及仪器" min-width="200">
                <template #default="{ row }">
                    <template v-if="row.isEditing">
                        <el-input v-model="row.comparison_unit_b_instrument" size="small" @click.stop></el-input>
                    </template>
                ...
                <el-row :gutter="20">
                    ...
                    <el-col :span="12">
                        <el-form-item label="调查项目/仪器" prop="investigation_item_instrument">
                            <el-input v-model="formData.investigation_item_instrument" placeholder="请输入调查项目/仪器"></el-input>
                        </el-form-item>
                    </el-col>
                </el-row>
                <el-row :gutter="20">
                    <el-col :span="12">
                        <el-form-item label="比测单位甲及仪器" prop="comparison_unit_a_instrument">
                            <el-input v-model="formData.comparison_unit_a_instrument" placeholder="请输入比测单位甲及仪器"></el-input>
                        </el-form-item>
                    </el-col>
                    <el-col :span="12">
                        <el-form-item label="比测单位乙及仪器" prop="comparison_unit_b_instrument">
                            <el-input v-model="formData.comparison_unit_b_instrument" placeholder="请输入比测单位乙及仪器"></el-input>
                        </el-form-item>
                    </el-col>
                </el-row>
                <el-row :gutter="20">
