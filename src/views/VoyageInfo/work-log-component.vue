    ...
    <div class="work-log">
        ...
        >
            ...
            <el-table-column prop="survey_project" label="调查项目" width="200" align="center">
                <template #default="{ row }">
                    <template v-if="row.isEditing">
                        <el-input v-model="row.survey_project" size="small" @click.stop></el-input>
                    </template>
            ...
            <el-table-column prop="work_log" label="工作日志" min-width="200">
                <template #default="{ row }">
                    <template v-if="row.isEditing">
                        <el-input v-model="row.work_log" type="textarea" :rows="2" size="small" @click.stop></el-input>
                    </template>
                ...
                <el-row :gutter="20">
                    ...
                    <el-col :span="12">
                        <el-form-item label="调查项目" prop="survey_project">
                            <el-input v-model="formData.survey_project" placeholder="请输入调查项目" />
                        </el-form-item>
                    </el-col>
                </el-row>
