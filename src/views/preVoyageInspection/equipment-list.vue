...
// 上传相关
const uploadUrl = `${import.meta.env.VITE_APP_BASE_API || 'http://39.105.158.84:5000/api'}/equipment/upload`;
const importUrl = `${import.meta.env.VITE_APP_BASE_API || 'http://39.105.158.84:5000/api'}/equipment/import`;
